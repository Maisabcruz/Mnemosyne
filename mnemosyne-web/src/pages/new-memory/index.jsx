...
const NewMemory = () => {
    ...
    const onSetImage = (event) => {
        // Ao selecionar uma imagem, execute aqui...
        const files = event.target.files; //Pegas os arquivos inseridos.
        SetImages(files);
        ...
        for (let contador = 0; contador < files.length; contador++) {
            ...
            imageURLs.push(thumbnail); //Acresenta na lista.
